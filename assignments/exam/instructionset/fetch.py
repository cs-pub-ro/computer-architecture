...
question = """
<div>
    <p> Having the following memory addressing table, instruction format table, registers address table, and opcode table. What is the encoding of the following instuction {} in hexadecimal (starting with 0x) ? </p>
    <div>
