...
set_property -dict { PACKAGE_PIN T8    IOSTANDARD LVCMOS18 } [get_ports { i_w_cin }]; #IO_L24N_T3_34 Sch=sw[8]
...
set_property -dict { PACKAGE_PIN R18   IOSTANDARD LVCMOS33 } [get_ports { o_w_cout }]; #IO_L7P_T1_D09_14 Sch=led[4]
